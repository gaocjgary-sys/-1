...
export const CHINESE_BRANDS_MATRIX = [
  ...
  { brandEn: 'Westlake (ZC Rubber)', brandCn: '西湖轮胎 (中策橡胶)', importers: ['Distri Cash', 'Copadex', 'CFP Wholesale', 'Norauto', 'Point S', 'Feu Vert', '1001Pneus', 'Muchpneu', 'Sogep Pneus', 'SLPA Pneus', 'CIAAK Auto', 'Auto Hrvatska', 'Pneumatik', 'Euroton', 'Vulkal', 'Gumi Centar Kordić', 'GMT', 'Petrol', 'Anet', 'Omega LLC'] },
  { brandEn: 'Ceat', brandCn: 'CEAT 轮胎', importers: ['Distri Cash'] },
  { brandEn: 'Roadking', brandCn: '路王轮胎', importers: ['Distri Cash', 'Garazh.ua'] },
  { brandEn: 'Linglong', brandCn: '玲珑轮胎', importers: ['Copadex', 'Massa Group', 'Interpneu', 'Bertrand Pneus', 'Soreg Pneus', 'Sogep Pneus', 'SLPA Pneus', 'Tokić', 'Pneumatik', 'Gumiimpex', 'Bartog', 'Euroton', 'Furlan', 'Špan', 'Avto Sitar', 'Norauto', 'Allopneus', 'Auto Antonio', 'Gumi Centar Kordić', 'GMT', 'Anet', 'Zapaska', 'Omega LLC'] },
  ...
  { brandEn: 'Sentury (Landsail/Delinte)', brandCn: '森麒麟 (路航/德林特)', importers: ['Massa Group', 'Bertrand Pneus', 'Speedy', 'Paris Pneus', 'Tokić', 'Pneumatik', 'Bartog', 'Furlan'] },
  { brandEn: 'Jinyu', brandCn: '金宇轮胎', importers: ['Paris Pneus'] },
  ...
  { brandEn: 'Wanli', brandCn: '万力轮胎', importers: ['Allopneus', 'Dipropneu', 'Feu Vert', 'Alsagom', 'POD Ouest', 'Auto Antonio'] },
  { brandEn: 'Sunwide', brandCn: '尚威轮胎', importers: ['Allopneus'] },
  { brandEn: 'Shengtai', brandCn: '盛泰轮胎 (三工)', importers: ['Pneumacy'] },
  { brandEn: 'Hongsheng', brandCn: '鸿升轮胎', importers: ['Rapide Tyres'] },
  { brandEn: 'Aplus', brandCn: '奥普勒斯轮胎', importers: ['GR Pneus'] },
